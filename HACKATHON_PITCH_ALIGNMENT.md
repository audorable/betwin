...
This document maps the **BeTwin Agent** platform's technical implementation and clinical features against the official hackathon judging criteria. It provides our foundational engineering and agentic answers and establishes dedicated placeholders for **JO (Design/Dev)**, **AUDREY (Business/Storytelling)**, and **RACHEL (Clinical Research)** to input their specialized alignments for the final pitch.
...
### 👩‍⚕️ Clinical Research Contributions (RACHEL to complete)
> [!IMPORTANT]
> **RACHEL (Clinical Lead)**: Please add verified research points, oncologist feedback (e.g., from NCCS, NCIS, or SGH), and patient survey statistics highlighting why outpatients fail to track side effects or struggle to communicate boundaries with their families.
> *   *Placeholder for Rachel's patient research findings...*
> *   *Placeholder for clinician feedback on pre-appointment briefing cards...*

### 📣 Stakeholder Narrative (AUDREY to complete)
> [!TIP]
> **AUDREY (Business Analyst & Storyteller)**: Please capture the voice of real-life breast cancer survivors in Singapore, outlining the "why" behind the BeTwin platform, Terry's demographic reality, and how we map to the Breast Cancer Foundation's (BCF) core caregiving priorities.
...
### 💻 Developer Implementation & Visual Shell (JO to complete)
> [!IMPORTANT]
> **JO (Frontend Dev & Designer)**: Please outline your integration details working with Claude, how you plugged our hooks into your custom design shells, and the visual architecture of the standalone white card components.
> *   *Placeholder for JO's React component structure...*
...
### 🎨 Visual Theme & UX Language (JO to complete)
> [!NOTE]
> **JO (UX Lead)**: Please add descriptions of the frosted-glass Light Theme design language, soft rose/teal color palettes, typography selections, and why this layout reduces cognitive load for oncology outpatients.
...
### 🎬 Live Pitch Storytelling Script (AUDREY to complete)
> [!TIP]
> **AUDREY (Presenter)**: Please detail the step-by-step human narrative for the live pitch, showing the contrast between Terry's anxiety at the start and her sense of relief once she syncs her prep cards.
...
### 💡 Novel Design Concepts (JO & RACHEL to complete)
> [!NOTE]
> **JO & RACHEL**: Add details on why a voice-guided, telemetry-tracked Outpatient Companion is superior to traditional static brochures or clinical symptom forms.
...
### 🛠️ Foundational Technical & Agentic Answers
*   **Clinician-Curation Panel (`resources/`)**: Rachel the clinician can edit all emergency helplines, BCF guidelines, and Singapore hospital directories inside `clinical_resources.json` without writing a single line of React code. This makes the system instantly adaptable for any NGO.
...
### 🚀 Future Roadmap & Hospital Integration (RACHEL & AUDREY to complete)
> [!IMPORTANT]
> **RACHEL & AUDREY**: Please detail the pilot rollout plan, detailing hospital integrations (e.g., SingHealth NCCS / NUHS NCIS), corporate sponsorships, and plans to recruit and match Bigger Sisters across Singapore.
